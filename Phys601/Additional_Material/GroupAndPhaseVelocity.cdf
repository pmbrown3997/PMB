...
NotebookDataLength[     80478,       1629]
NotebookOptionsPosition[     53239,       1043]
NotebookOutlinePosition[     79491,       1604]
CellTagsIndexPosition[     79380,       1598]
WindowTitle->Group and Phase Velocity
WindowFrame->Normal*)
...
Cell["Group and Phase Velocity", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`k$$ = 
    0.28049999999999997`, $CellContext`t$$ = 
    2.74, $CellContext`\[Omega]$$ = -0.6600000000000001, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{
      Hold[$CellContext`t$$], 0., 10.}, {{
       Hold[$CellContext`k$$], 0.2, "\[CapitalDelta]k"}, 0.1, 0.4}, {{
       Hold[$CellContext`\[Omega]$$], 0.2, "\[CapitalDelta]\[Omega]"}, -3, 
      3}}, Typeset`size$$ = {500., {98., 102.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`t$41480$$ = 0, $CellContext`k$41481$$ = 
    0, $CellContext`\[Omega]$41482$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`k$$ = 0.2, $CellContext`t$$ = 
        0., $CellContext`\[Omega]$$ = 0.2}, "ControllerVariables" :> {
        Hold[$CellContext`t$$, $CellContext`t$41480$$, 0], 
        Hold[$CellContext`k$$, $CellContext`k$41481$$, 0], 
        Hold[$CellContext`\[Omega]$$, $CellContext`\[Omega]$41482$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Plot[{Cos[(6 - $CellContext`k$$) $CellContext`x - (
            6 - $CellContext`\[Omega]$$) $CellContext`t$$] + 
         Cos[(6 + $CellContext`k$$) $CellContext`x - (
            6 + $CellContext`\[Omega]$$) $CellContext`t$$], 2 
         Cos[(-$CellContext`k$$) $CellContext`x + $CellContext`\[Omega]$$ \
$CellContext`t$$], (-2) 
         Cos[(-$CellContext`k$$) $CellContext`x + $CellContext`\[Omega]$$ \
$CellContext`t$$]}, {$CellContext`x, 0, 30}, ImageSize -> {500, 200}, 
        AspectRatio -> 1/5, Frame -> True, PlotRange -> {{0, 30}, {-2, 2}}, 
        PlotStyle -> {Automatic, Dashed, Dashed}, PlotLabel -> 
        Row[{"\!\(\*SubscriptBox[\(v\), \(g\)]\) = ", 
           NumberForm[$CellContext`\[Omega]$$/$CellContext`k$$, 3]}], 
        Epilog -> {Green, 
          PointSize[0.01], 
          Table[
           
           Point[{(Pi $CellContext`n + $CellContext`\[Omega]$$ \
$CellContext`t$$ + Pi/2)/$CellContext`k$$, 0}], {$CellContext`n, -15, 15}], 
          Red, 
          
          Point[{$CellContext`t$$, 
            Cos[(6 - $CellContext`k$$) $CellContext`t$$ - (
               6 - $CellContext`\[Omega]$$) $CellContext`t$$] + 
            Cos[(6 + $CellContext`k$$) $CellContext`t$$ - (
               6 + $CellContext`\[Omega]$$) $CellContext`t$$]}]}], 
      "Specifications" :> {{$CellContext`t$$, 0., 10., Appearance -> 
         "Labeled"}, {{$CellContext`k$$, 0.2, "\[CapitalDelta]k"}, 0.1, 0.4, 
         Appearance -> 
         "Labeled"}, {{$CellContext`\[Omega]$$, 0.2, 
          "\[CapitalDelta]\[Omega]"}, -3, 3, Appearance -> "Labeled"}}, 
      "Options" :> {}, "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {169., 174.}},
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["v", "g"], TraditionalForm]], "InlineMath"],
 " is the speed of the overall shape of a modulated wave (called the \
envelope). This is defined by ",
 Cell[BoxData[
  FormBox[
   RowBox[{"d", "\[InvisibleSpace]", 
    RowBox[{"\[Omega]", "/", "d"}], "\[InvisibleSpace]", "k"}], 
   TraditionalForm]], "InlineMath"],
 " (chosen here to equal 1), where ",
 Cell[BoxData[
  FormBox["\[Omega]", TraditionalForm]], "InlineMath"],
 " is the angular velocity and ",
 Cell[BoxData[
  FormBox["k", TraditionalForm]], "InlineMath"],
 " is the wave number. The phase velocity ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["v", "p"], TraditionalForm]], "InlineMath"],
 " of a wave is the speed at which a given phase of a wave travels through \
space, equal to ",
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Omega]", "/", "k"}], TraditionalForm]], "InlineMath"],
 "."
}], "ManipulateCaption"],
...
Cell[TextData[{
 "The wave shown here is a sum of two waves that differ by a small phase \
(called a beat) of the form ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"cos", "(", 
     RowBox[{
      RowBox[{
       RowBox[{"(", 
        RowBox[{"k", "-", 
         RowBox[{"\[CapitalDelta]", "\[InvisibleSpace]", "k"}]}], ")"}], " ", 
       "x"}], "-", 
      RowBox[{
       RowBox[{"(", 
        RowBox[{"\[Omega]", "-", "\[CapitalDelta]\[Omega]"}], ")"}], "t"}]}], 
     ")"}], "+", 
    RowBox[{"cos", "(", 
     RowBox[{
      RowBox[{
...
Cell[TextData[{
 ButtonBox["Angular Frequency",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/AngularFrequency.html"], 
    None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/AngularFrequency.html"],
 " (",
...
Cell[TextData[{
 ButtonBox["Group Velocity",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/GroupVelocity.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/GroupVelocity.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Phase Velocity",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/PhaseVelocity.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/PhaseVelocity.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Wavenumber",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Wavenumber.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/Wavenumber.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
GroupAndPhaseVelocity&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/GroupAndPhaseVelocity/\
GroupAndPhaseVelocity-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Group and Phase Velocity",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/GroupAndPhaseVelocity/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/GroupAndPhaseVelocity/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/GroupAndPhaseVelocity/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/GroupAndPhaseVelocity/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/GroupAndPhaseVelocity/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39458, 693, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39719, 702, 3722, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[52417, 1018, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 79093, 1587},
 {"Copyright", 79288, 1592}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34967, 592, 3529, 69, 70, "Output",
 CellID->616569897],
Cell[38499, 663, 956, 28, 70, "ManipulateCaption"],
Cell[39458, 693, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39719, 702, 3722, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43444, 786, 33, 0, 70, "DetailsSection"],
Cell[43480, 788, 903, 30, 70, "DetailNotes",
 CellID->2025651010],
Cell[44386, 820, 44, 0, 70, "RelatedLinksSection"],
Cell[44433, 822, 511, 16, 70, "RelatedLinks",
 CellID->944359599],
Cell[44947, 840, 498, 15, 70, "RelatedLinks",
 CellID->1714453622],
Cell[45448, 857, 498, 15, 70, "RelatedLinks",
 CellID->2033933155],
Cell[45949, 874, 487, 15, 70, "RelatedLinks",
 CellID->669843139],
Cell[46439, 891, 4802, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[51244, 982, 45, 0, 70, "CitationSection"],
Cell[51292, 984, 792, 20, 70, "Citations"],
Cell[52087, 1006, 327, 10, 70, "Author"],
Cell[52417, 1018, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature yQqsF2WW4Ua5yxQNROazMeDV *)
